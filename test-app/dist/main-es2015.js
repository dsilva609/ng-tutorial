...
/* harmony import */ var _product_alerts_product_alerts_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./product-alerts/product-alerts.component */ "./src/app/product-alerts/product-alerts.component.ts");
    ...
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forRoot([
                { path: "", component: _product_list_product_list_component__WEBPACK_IMPORTED_MODULE_10__["ProductListComponent"] },
                { path: "products/:productId", component: _product_details_product_details_component__WEBPACK_IMPORTED_MODULE_12__["ProductDetailsComponent"] },
        ...
        declarations: [
            ...
            _product_alerts_product_alerts_component__WEBPACK_IMPORTED_MODULE_11__["ProductAlertsComponent"],
...
/* harmony import */ var _cart_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cart.service */ "./src/app/cart/cart.service.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var _cart_query__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cart.query */ "./src/app/cart/cart.query.ts");
...
let CartComponent = class CartComponent {
    constructor(cartService, cartQuery, formBuilder) {
...
/* harmony import */ var _cart_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cart.store */ "./src/app/cart/cart.store.ts");




let CartQuery = class CartQuery extends _datorama_akita__WEBPACK_IMPORTED_MODULE_2__["QueryEntity"] {
    constructor(store) {
        super(store);
        this.store = store;
    }
};
CartQuery.ctorParameters = () => [
    { type: _cart_store__WEBPACK_IMPORTED_MODULE_3__["CartStore"] }
];
CartQuery = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _cart_cart_query__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../cart/cart.query */ "./src/app/cart/cart.query.ts");
...
let ProductDetailsComponent = class ProductDetailsComponent {
    constructor(route, cartService, cartQuery) {
        this.route = route;
        this.cartService = cartService;
        this.cartQuery = cartQuery;
    }
    ngOnInit() {
        this.route.paramMap.subscribe((params) => {
            this.product = _products__WEBPACK_IMPORTED_MODULE_2__["products"][+params.get("productId")];
        });
    }
    addToCart(product) {
...
class Product {
    constructor(id, description, name, price) {
        this.id = id;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShippingPrice", function() { return ShippingPrice; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
module.exports = __webpack_require__(/*! D:\GitSandbox\ng-tutorial\test-app\src\main.ts */"./src/main.ts");
